        ...
        if(user2 !== null && amount !== 0 && amount !== null){            
            ...
            if(userobj2 !== null){
                if(checkBalance(userobj1.balance)){
                    ...
                    alert(`${userobj1.username} deposited ${formatPrice(amount*100)} to ${userobj2.username}`)
    ...
    return (
        <div>
            <form className="transfer-form">
                ...
                <input type="text" className="inputs" placeholder="Enter Username" onChange={(e) => {setUser2(e.target.value)}}/>
